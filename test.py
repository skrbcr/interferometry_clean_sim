...
if __name__ == '__main__':
    ...
    # Set antenna array
    antenna_pos, uv_coverage = clean.set_antenna_array('Y', 8, b_min=0.05, b_max=0.4, random_seed=0, Nt=1, declination=np.pi / 4, )
    ...
    # Clean the image
    psf, model, residual, image = clean.clean(vis, imsize, 'natural', n_iter=10000, threshold=1e-16, mask=maskfile, gamma=0.2)
